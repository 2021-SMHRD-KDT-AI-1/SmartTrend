			...
			<article>
                ...
                function getClickHandler(seq) {
                    return function (e) {
                        ...
                        location.href = "trippage.html?loc='광주'";

                    }
                }
               naver.maps.Event.addListener(markerGwangju, 'click', getClickHandler(1));
               naver.maps.Event.addListener(markerUlsan, 'click', getClickHandler(2));
               naver.maps.Event.addListener(markerBusan, 'click', getClickHandler(3));
               naver.maps.Event.addListener(markerDaejeon, 'click', getClickHandler(4));
               naver.maps.Event.addListener(markerDaegu, 'click', getClickHandler(5));
               naver.maps.Event.addListener(markerSeoul, 'click', getClickHandler(6));
               naver.maps.Event.addListener(markerJeju, 'click', getClickHandler(7));
