...
<%@page import="com.VO.covidDataVO"%>
<%@page import="com.DAO.CovidDataDAO"%>
<%@ page language="java" contentType="text/html; charset=EUC-KR"
    pageEncoding="EUC-KR"%>
<%
		CovidDataDAO dao = new CovidDataDAO();
		ArrayList<covidDataVO> list = dao.address();

		covidDataVO covid_Gw = null;
		covidDataVO covid_Se = null;
		covidDataVO covid_Je = null;
		covidDataVO covid_Bu = null;
		covidDataVO covid_Gn = null;
		covidDataVO covid_Gb = null;
		covidDataVO covid_Jn = null;
		covidDataVO covid_Jb = null;
		covidDataVO covid_Ga = null;
		covidDataVO covid_Gg = null;
		covidDataVO covid_Us = null;
		covidDataVO covid_Ic = null;
		covidDataVO covid_Dg = null;
		covidDataVO covid_Dj = null;
		covidDataVO covid_Cb = null;
		covidDataVO covid_Cn = null;
		...
		for (int i=0; i<list.size(); i++) {
			if (list.get(i).getDay().equals(timeS)){
				if (list.get(i).getZone().equals("광주")) {
					covid_Gw = list.get(i);
				} else if (list.get(i).getZone().equals("서울")) {
					covid_Se = list.get(i);
				} else if (list.get(i).getZone().equals("제주")) {
					covid_Je = list.get(i);
				} else if (list.get(i).getZone().equals("부산")) {
					covid_Bu = list.get(i);
				} else if (list.get(i).getZone().equals("경남")) {
					covid_Gn = list.get(i);
				} else if (list.get(i).getZone().equals("경북")) {
					covid_Gb = list.get(i);
				} else if (list.get(i).getZone().equals("전남")) {
					covid_Jn = list.get(i);
				} else if (list.get(i).getZone().equals("전북")) {
					covid_Jb = list.get(i);
				} else if (list.get(i).getZone().equals("강원")) {
					covid_Ga = list.get(i);
				} else if (list.get(i).getZone().equals("경기")) {
					covid_Gg = list.get(i);
				} else if (list.get(i).getZone().equals("울산")) {
					covid_Us = list.get(i);
				} else if (list.get(i).getZone().equals("인천")) {
					covid_Ic = list.get(i);
				} else if (list.get(i).getZone().equals("대구")) {
					covid_Dg = list.get(i);
				} else if (list.get(i).getZone().equals("대전")) {
					covid_Dj = list.get(i);
				} else if (list.get(i).getZone().equals("충북")) {
					covid_Cb = list.get(i);
				} else if (list.get(i).getZone().equals("충남")) {
					covid_Cn = list.get(i);
				} 
...
-->
	<style>
		...
		#jeonnam, #jeonnam~path 
			<%if (Integer.parseInt((covid_Jn.getConfirmedPatient()))>100) {%>
				{ fill: rgb(1, 32, 32); }
			<%} else if (Integer.parseInt((covid_Jn.getConfirmedPatient()))>10) {%>
				{ fill: rgb(15, 107, 109); }
			<%} else {%>
				{ fill: rgb(23, 179, 182); }	
			<%}%>
		#inc, #inc+path
			<%if (Integer.parseInt((covid_Ic.getConfirmedPatient()))>100) {%>
				{ fill: rgb(1, 32, 32); }
			<%} else if (Integer.parseInt((covid_Ic.getConfirmedPatient()))>10) {%>
				{ fill: rgb(15, 107, 109); }
			<%} else {%>
				{ fill: rgb(23, 179, 182); }	
			<%}%>
		#sj
			<%if (Integer.parseInt((covid_Dj.getConfirmedPatient()))>100) {%>
				{ fill: rgb(1, 32, 32); }
			<%} else if (Integer.parseInt((covid_Dj.getConfirmedPatient()))>10) {%>
				{ fill: rgb(15, 107, 109); }
			<%} else {%>
				{ fill: rgb(23, 179, 182); }	
			<%}%>
		#gg
			<%if (Integer.parseInt((covid_Gg.getConfirmedPatient()))>100) {%>
				{ fill: rgb(1, 32, 32); }
			<%} else if (Integer.parseInt((covid_Gg.getConfirmedPatient()))>10) {%>
				{ fill: rgb(15, 107, 109); }
			<%} else {%>
				{ fill: rgb(23, 179, 182); }	
			<%}%>
		#gnam, #gnam+path
			<%if (Integer.parseInt((covid_Gn.getConfirmedPatient()))>100) {%>
				{ fill: rgb(1, 32, 32); }
			<%} else if (Integer.parseInt((covid_Gn.getConfirmedPatient()))>10) {%>
				{ fill: rgb(15, 107, 109); }
			<%} else {%>
				{ fill: rgb(23, 179, 182); }	
			<%}%>
		#gbuk
			<%if (Integer.parseInt((covid_Gb.getConfirmedPatient()))>100) {%>
				{ fill: rgb(1, 32, 32); }
			<%} else if (Integer.parseInt((covid_Gb.getConfirmedPatient()))>10) {%>
				{ fill: rgb(15, 107, 109); }
			<%} else {%>
				{ fill: rgb(23, 179, 182); }	
			<%}%>
		#gangwon
			<%if (Integer.parseInt((covid_Ga.getConfirmedPatient()))>100) {%>
				{ fill: rgb(1, 32, 32); }
			<%} else if (Integer.parseInt((covid_Ga.getConfirmedPatient()))>10) {%>
				{ fill: rgb(15, 107, 109); }
			<%} else {%>
				{ fill: rgb(23, 179, 182); }	
			<%}%>
		#cnfqnr
			<%if (Integer.parseInt((covid_Cb.getConfirmedPatient()))>100) {%>
				{ fill: rgb(1, 32, 32); }
			<%} else if (Integer.parseInt((covid_Cb.getConfirmedPatient()))>10) {%>
				{ fill: rgb(15, 107, 109); }
			<%} else {%>
				{ fill: rgb(23, 179, 182); }	
			<%}%>
		#cndska, #cndska+path
			<%if (Integer.parseInt((covid_Cn.getConfirmedPatient()))>100) {%>
				{ fill: rgb(1, 32, 32); }
			<%} else if (Integer.parseInt((covid_Cn.getConfirmedPatient()))>10) {%>
				{ fill: rgb(15, 107, 109); }
			<%} else {%>
				{ fill: rgb(23, 179, 182); }	
			<%}%>
		#ulsan
			<%if (Integer.parseInt((covid_Us.getConfirmedPatient()))>100) {%>
				{ fill: rgb(1, 32, 32); }
			<%} else if (Integer.parseInt((covid_Us.getConfirmedPatient()))>10) {%>
				{ fill: rgb(15, 107, 109); }
			<%} else {%>
				{ fill: rgb(23, 179, 182); }	
			<%}%>
		#jeonbuk
			<%if (Integer.parseInt((covid_Jb.getConfirmedPatient()))>100) {%>
				{ fill: rgb(1, 32, 32); }
			<%} else if (Integer.parseInt((covid_Jb.getConfirmedPatient()))>10) {%>
				{ fill: rgb(15, 107, 109); }
			<%} else {%>
				{ fill: rgb(23, 179, 182); }	
			<%}%>
		#deagu
			<%if (Integer.parseInt((covid_Dg.getConfirmedPatient()))>100) {%>
				{ fill: rgb(1, 32, 32); }
			<%} else if (Integer.parseInt((covid_Dg.getConfirmedPatient()))>10) {%>
				{ fill: rgb(15, 107, 109); }
			<%} else {%>
				{ fill: rgb(23, 179, 182); }	
			<%}%>
		#gwangju
			<%if (Integer.parseInt((covid_Gw.getConfirmedPatient()))>100) {%>
				{ fill: rgb(1, 32, 32); }
			<%} else if (Integer.parseInt((covid_Gw.getConfirmedPatient()))>10) {%>
				{ fill: rgb(15, 107, 109); }
			<%} else {%>
				{ fill: rgb(23, 179, 182); }	
			<%}%>
		#jeju
			<%if (Integer.parseInt((covid_Je.getConfirmedPatient()))>100) {%>
				{ fill: rgb(1, 32, 32); }
			<%} else if (Integer.parseInt((covid_Je.getConfirmedPatient()))>10) {%>
				{ fill: rgb(15, 107, 109); }
			<%} else {%>
				{ fill: rgb(23, 179, 182); }	
			<%}%>
		#busan
			<%if (Integer.parseInt((covid_Bu.getConfirmedPatient()))>100) {%>
				{ fill: rgb(1, 32, 32); }
			<%} else if (Integer.parseInt((covid_Bu.getConfirmedPatient()))>10) {%>
				{ fill: rgb(15, 107, 109); }
			<%} else {%>
				{ fill: rgb(23, 179, 182); }	
			<%}%>
		#seoul
			<%if (Integer.parseInt((covid_Se.getConfirmedPatient()))>100) {%>
				{ fill: rgb(1, 32, 32); }
			<%} else if (Integer.parseInt((covid_Se.getConfirmedPatient()))>10) {%>
				{ fill: rgb(15, 107, 109); }
			<%} else {%>
				{ fill: rgb(23, 179, 182); }	
			<%}%>
		...
		#jeonnam:hover, #jeonnam:hover~path,
		#inc:hover, #inc:hover+path,
		#sj:hover,
		#gg:hover,
		#gnam:hover, #gnam:hover+path,
		#gbuk:hover,
		#gangwon:hover,
		#cnfqnr:hover,
		#cndska:hover, #cndska:hover+path,
		#ulsan:hover,
		#jeonbuk:hover,
		#deagu:hover,
		#gwangju:hover,
		#jeju:hover,
		#busan:hover,
		#seoul:hover { fill: rgb(255, 255, 255); }
					...
					<header id="header">
						...
						<section>
							...
							preserveAspectRatio="xMidYMid meet">
								...
								<a href="subpage.jsp?loc=Seoul">
								<path id="seoul" d="M3804 5905 c-8 -31 -32 -45 -78 -45 -35 0 -35 -1 -24 -26 11 -23 10
								...
								34 -9 8 -15 29 -15 56 l0 44 -50 0 c-45 0 -50 -2 -56 -25z"/></a>
								...
								<a href="subpage.jsp?loc=Jeju">
								<path id="jeju" d="M3385 503 c-76 -10 -118 -20 -138 -34 -15 -11 -64 -26 -109 -34 -44
								...
								<a href="subpage.jsp?loc=Busan">
								<path id="busan" d="M6367 2620 c-5 -20 -10 -22 -41 -16 -34 6 -35 5 -41 -27 -7 -34 -39
								...
								182 -6 11 -16 20 -23 20 -7 0 -22 3 -33 6 -16 4 -23 0 -27 -16z"/></a>
						...
						<%-- <nav>
							<ul class="defalt_info info">
								...
								<li class="covid_info covid_info3"><div></div></li>
								<li class="covid_info covid_info4"><div></div></li>
							</ul>
							<ul class="gw_info info">
								<li class="covid_info covid_info1"><div><span>확진자수<br><%=covid_Gw.getConfirmedPatient() %></span></div></li>
								<li class="covid_info covid_info2"><div><span>해외유입<br><%=covid_Gw.getForeignImport() %></span></div></li>
								<li class="covid_info covid_info3"><div><span>격리환자<br><%=covid_Gw.getInQuarantine() %></span></div></li>
								<li class="covid_info covid_info4"><div><span>격리헤제<br><%=covid_Gw.getReleaseFromQuarantine() %></span></div></li>
							</ul>
							<ul class="bu_info info">
								<li class="covid_info covid_info1"><div><span>확진자수<br><%=covid_Bu.getConfirmedPatient() %></span></div></li>
								<li class="covid_info covid_info2"><div><span>해외유입<br><%=covid_Bu.getForeignImport() %></span></div></li>
								<li class="covid_info covid_info3"><div><span>격리환자<br><%=covid_Bu.getInQuarantine() %></span></div></li>
								<li class="covid_info covid_info4"><div><span>격리헤제<br><%=covid_Bu.getReleaseFromQuarantine() %></span></div></li>
							</ul>
							<ul class="se_info info">
